...
public class Field {
    ...
    public enum FieldType {
        ...
        RESPONSE_MESSAGE_BYTES("Response Message Bytes", "responsemsgbytes", new FieldValidator[] {new NonNegativeNumberFieldValidator()}),
        THINK_SECONDS("Think Seconds", "thinksecs", new FieldValidator[] {new NonNegativeNumberFieldValidator()}),
        REQUEST_LOADBALANCER_SERVICE_TIME("Request Load Balance Service Time Seconds%s", "reqlbsecs", new FieldValidator[] {new RangeFieldValidator(0.0001, 10)}),
    ...
    public Field(FieldType fieldType, String name) {
        // Set the field type.
        ...
        String labelText = String.format(fieldType.label, name.isEmpty() ? "" : " (" + name + ")");
